...
if 'ENABLE_PAGES' in app.config:
    pages_enabled = app.config['ENABLE_PAGES']
if 'ENABLE_API' in app.config:
...
##
# Pages
# (only enabled if ENABLE_PAGES is set to True in portero_config.py!)
##
